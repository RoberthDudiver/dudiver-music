...
public sealed class LocalizationManager : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["SearchPh"] = "Buscar en la playlist…",
        ["RemoveTrack"] = "Quitar de la playlist",
        ["DeleteTitle"] = "¿Eliminar playlist?",
        ["DeleteText"] = "Se va a eliminar «{0}». Esta acción no se puede deshacer.",
        ["Cancel"] = "Cancelar",
        ["Delete"] = "Eliminar",
        ["TipMute"] = "Silenciar",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["SearchPh"] = "Search this playlist…",
        ["RemoveTrack"] = "Remove from playlist",
        ["DeleteTitle"] = "Delete playlist?",
        ["DeleteText"] = "“{0}” will be deleted. This can't be undone.",
        ["Cancel"] = "Cancel",
        ["Delete"] = "Delete",
        ["TipMute"] = "Mute",
